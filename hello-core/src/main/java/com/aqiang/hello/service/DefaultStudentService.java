...
public class DefaultStudentService implements StudentService {
	...
	// // name)));
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.eq("name",
	// name)).query();
	// }
	//
	// @Override
	...
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(or).query();
	// }
	//
	// @Override
	// public List<Student> getStudentsByNameAndAge(String name, int age) {
	...
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.eq("name", name))
	// .where(Conditions.eq("age", age)).query();
	// }
	//
	// @Override
	// public List<Student> getStudentsByNameAndAgeAndGender(String name, int
	// age, String gender) {
	// // return dao.list(Student.class,
	...
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.eq("name", name))
	// .where(Conditions.eq("age", age)).where(Conditions.eq("gender",
	// gender)).query();
	// }
	//
	// @Override
	...
	// // age)));
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.gt("age",
	// age)).query();
	// }
	//
	// @Override
	...
	// // age)));
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.gteq("age",
	// age)).query();
	// }
	//
	// @Override
	...
	// // age)));
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.lt("age",
	// age)).query();
	// }
	//
	// @Override
	...
	// // age)));
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.lteq("age",
	// age)).query();
	// }
	//
	// @Override
	...
	// // age)));
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.eq("age",
	// age)).query();
	// }
	//
	// @Override
	...
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.isNull("gender")).query();
	// }
	//
	// @Override
	// public List<Student> getStudentsGenderIsNotNull() {
	...
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.isNotNull("gender")).query();
	// }
	//
	// @Override
	// public List<Student> getStudentsByGender(String gender) {
	...
	// // gender)));
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.eq("gender",
	// gender)).query();
	// }
	//
	// @Override
	...
	// return (List<Student>)
	// dao.query().setClazz(Student.class).order(Orders.asc("name")).query();
	// }
	//
	// @Override
	// public List<Student> getstudentsOrderByNameDesc() {
	...
	// return (List<Student>)
	// dao.query().setClazz(Student.class).order(Orders.desc("name")).query();
	// }
	//
	// @Override
	// public List<Student> getstudentsOrderByNameAndAgeDesc() {
	...
	// return (List<Student>)
	// dao.query().setClazz(Student.class).order(Orders.asc("name")).order(Orders.desc("age"))
	// .query();
	// }
	//
	// @Override
	...
	// // name)));
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(Conditions.like("name",
	// name)).query();
	// }
	//
	// @Override
	// public List<Student> getStudentsByNameAndAgeOrGenderIsNull(String string,
	// int age) {
	// ComplexCondition or = Conditions.or();
	...
	//
	// @Override
	// public List<Student> getStudentsByNameOrAgeAndGenderIsNull(String string,
	// int age) {
	// ComplexCondition or = Conditions.or();
	// ComplexCondition and = Conditions.and();
	// and.add(or);
	...
	// return (List<Student>)
	// dao.query().setClazz(Student.class).where(and).query();
	// }
